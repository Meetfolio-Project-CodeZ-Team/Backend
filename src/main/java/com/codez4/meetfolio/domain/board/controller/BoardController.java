...
public class BoardController {
    ...
    public ApiResponse<BoardResponse.BoardListResult> getEmploymentBoards(@AuthenticationMember Member member,
        ...
        } else return ApiResponse.onSuccess(toBoardListResult(memberInfo,boardQueryService.getEmploymentBoards(member, page)));
    }
    ...
    @GetMapping("/group")
    public ApiResponse<BoardResponse.BoardListResult> getJobBoardList(@AuthenticationMember Member member,
                                                                      @RequestParam(name = "page") Integer page,
                                                                      @RequestParam(name = "category", required = false) String category) {
        MemberResponse.MemberInfo memberInfo = MemberResponse.toMemberInfo(member);
        if (category != null) {
        ...
        } else return ApiResponse.onSuccess(toBoardListResult(memberInfo,boardQueryService.getGroupBoards(member, page)));
    }
