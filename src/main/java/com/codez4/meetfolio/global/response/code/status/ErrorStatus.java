...
public enum ErrorStatus implements BaseErrorCode {
    ...
    _LOGOUT_USER(HttpStatus.NOT_FOUND, "AUTHENTICATION4003","로그아웃한 토큰입니다."),
    ...
    _MEMBER_ACTIVATED(HttpStatus.BAD_REQUEST,"MEMBER4003", "이미 활성화된 회원입니다."),
    _MEMBER_INACTIVATED(HttpStatus.BAD_REQUEST,"MEMBER4004", "이미 비활성화된 회원입니다."),
    ...
    // 모델 관련
    _MODEL_NOT_FOUND(HttpStatus.NOT_FOUND, "MODEL4001", "존재하지 않는 모델 데이터입니다."),
    ...
    // 댓글 관련
    _COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMENT4001", "존재하지 않는 댓글 데이터입니다."),
    _COMMENT_OVER_DEPTH_(HttpStatus.BAD_REQUEST, "COMMENT4002", "대댓글까지만 댓글을 작성할 수 있습니다.")
    ;
